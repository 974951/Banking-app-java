...
/* This class is used for saving User object to file, deals with File I/O Operation.*/
public class UserCurdFileUtility implements UserCurdUtility {
    private String dbPath;

    public UserCurdFileUtility() {
        dbPath = "C:\\Users\\Lenovo\\Documents\\BankDb\\";
    }
...
//success
    ...
    public User getUserDetails(Long accountNumber) {
        ...
        try {
            ...
            try (FileReader fileReader = new FileReader(dbPath + accountNumber)) {
